...
$(function() {
    ...
    // SASS
    sass_dom_element.on("mouseover", over_handler).on("mouseout", out_handler);
    // LESS
    less_dom_element.on("mouseover", over_handler).on("mouseout", out_handler);
    // Jade
    jade_dom_element.on("mouseover", over_handler).on("mouseout", out_handler);
    
});

over_handler = function() {
